...
const Productfeedback = () => {
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      try {
        const response = await axios.get(`https://bidwiseralpha.onrender.com/api/product/${productId}`);
  ...
  useEffect(() => {
    const fetchProductFeedback = async () => {
      try {
        const response = await axios.get(`https://bidwiseralpha.onrender.com/api/productfeedbacksfetch/${productId}`);
        if (response.data) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://bidwiseralpha.onrender.com/api/productfeedbacks', {
        productId,
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://bidwiseralpha.onrender.com/api/productfeedbacks/${productId}`, {
        rating,
        feedback,
      });
      if(response.data){
