...
const AdminPage = () => {
    ...
    useEffect(() => {
        const fetchAdminDetails = async () => {
            try {
                const adminResponse = await axios.get(`https://bidwiser.onrender.com/api/getUserByEmail/${userId}`);
    ...
    const addAdmin = async () => {
        try {
            ...
            const response = await axios.post('https://bidwiser.onrender.com/api/addAdmin', newAdminData);
