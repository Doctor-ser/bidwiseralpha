...
const AdminPage = () => {
  ...
  const fetchUserDetails = async () => {
    try {
      const response = await axios.get(`https://bidwiseralpha.onrender.com/api/getUserDetails/${email}`);
  ...
  const fetchUserBids = async () => {
    try {
      const response = await axios.get(`https://bidwiseralpha.onrender.com/api/getBidsByUser/${email}`);
  ...
  const deleteUser = async () => {
    try {
      const response = await axios.delete(`https://bidwiseralpha.onrender.com/api/users/${email}`);
      setUserDetails(null);
      setUserBids([]);
      setErrorMessage('');
